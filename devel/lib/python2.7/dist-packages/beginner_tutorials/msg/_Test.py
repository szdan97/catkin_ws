...
"""autogenerated by genpy from beginner_tutorials/Test.msg. Do not edit."""
import sys
...
class Test(genpy.Message):
  _md5sum = "5c369a168623ffa5c773a62397f3a9b4"
  _type = "beginner_tutorials/Test"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """Point2D a
float32 b
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['a','b','c']
  _slot_types = ['beginner_tutorials/Point2D','float32','std_msgs/Float32MultiArray[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.a is None:
        self.a = beginner_tutorials.msg.Point2D()
      if self.b is None:
        self.b = 0.
      if self.c is None:
        self.c = []
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2df().pack(_x.a.x, _x.a.y, _x.b))
      length = len(self.c)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.a.x, _x.a.y, _x.b,) = _get_struct_2df().unpack(str[start:end])
      start = end
      end += 4
