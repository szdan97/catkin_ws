...
(cl:defmethod cl:initialize-instance :after ((m <Point2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<Point2D> is deprecated: use beginner_tutorials-msg:Point2D instead.")))
