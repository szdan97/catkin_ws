...
class DataToAssociate(genpy.Message):
  _md5sum = "741a60cbfa41b774cb163e0c6d768d77"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['features','featureCovMatrices','measurements']
  _slot_types = ['beginner_tutorials/Point2D[]','std_msgs/Float32MultiArray[]','beginner_tutorials/Point2D[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       features,featureCovMatrices,measurements
    ...
    if args or kwds:
      ...
      if self.features is None:
        self.features = []
      if self.featureCovMatrices is None:
        self.featureCovMatrices = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.featureCovMatrices)
      buff.write(_struct_I.pack(length))
      for val1 in self.featureCovMatrices:
        _v1 = val1.layout
        length = len(_v1.dim)
        buff.write(_struct_I.pack(length))
        for val3 in _v1.dim:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.featureCovMatrices.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.measurements = []
